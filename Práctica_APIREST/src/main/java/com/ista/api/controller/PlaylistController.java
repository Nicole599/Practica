...
import com.ista.api.service.PlaylistService;
...
public class PlaylistController {
    ...
    public ResponseEntity<Playlist> addSongToPlaylist(@PathVariable String listName, @RequestBody Songs song) {
        Optional<Playlist> playlistOpt = playlistService.getPlaylistByName(listName);
        if (playlistOpt.isPresent()) {
            Playlist playlist = playlistOpt.get();
            Set<Songs> songs = playlist.getSongs();
            songs.add(song);
